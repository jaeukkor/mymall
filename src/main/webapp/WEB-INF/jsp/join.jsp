...
<body>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form id="joinform" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">회원 이름</label>
                      <div class="input-group has-validation">
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">연락처</label>
                      <div class="input-group has-validation">
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">주소</label>
                      <div class="input-group has-validation">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="button" onclick="join();">가입하기</button>
                    </div>
  ...
  <script>
    function join(){
    	...
    	call_server(joinform, "/joinProcess", confirmJoin);
    }
    
    function confirmJoin(c){
    	if(c>0){
    		alert("가입에 성공하였습니다.");
    		location.href='/login'
    	}else{
